...
namespace block_recommender\event\click;
defined('MOODLE_INTERNAL') || die();

class click_created extends \core\event\base {
    /**
     * Init method
     */
    ...
    public static function get_name() {
        return get_string('evententrycreated', 'block_recommender');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' has created a click on the course object with id '$this->objectid' for " .
